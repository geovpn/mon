...
echo -e "======================================"
echo -e "         V2Ray VLess Port Changer"
echo -e ""
echo -e "     [1]  Change Port V2Ray VLess Tls ${RED}$tls${NC}"
echo -e "     [2]  Change Port V2Ray VLess Non-Tls ${RED}$none${NC}"
echo -e "     [x]  Exit"
echo -e ""
echo -e "======================================"
echo -e ""
...
case $port in
1)
read -p "Type New Port For V2Ray VLess TLS: " tls1
if [ -z $tls1 ]; then
...
clear
echo -e "${GREEN}Succesfully Changed V2Ray TLS Port To $tls1${NC}"
else
...
read -p "Type New Port For V2Ray VLess Non-Tls : " none1
if [ -z $none1 ]; then
echo "Please Input Port"
exit 0
fi
...
clear
echo -e "${GREEN}Succesfully Change V2Ray VLess Non-Tls Port To $none1${NC}"
else
echo -e "${RED}Error ! ${NC}Port $none1 Is Already Used"
fi
;;
