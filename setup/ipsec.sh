...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/geovpn/sampi/main/add/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/geovpn/sampi/main/del/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/geovpn/sampi/main/add/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/geovpn/sampi/main/del/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/geovpn/sampi/main/renew/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/geovpn/sampi/main/renew/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/geovpn/data-user-l2tp
touch /var/lib/geovpn/data-user-pptp
rm -f /root/ipsec.sh
