...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/geovpn/sampi/main/add/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/geovpn/sampi/main/del/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/geovpn/sampi/main/renew/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
