...
wget -q -O /usr/local/bin/websocket https://raw.githubusercontent.com/geovpn/sampi/main/websocket/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/geovpn/sampi/main/websocket/ws-ovpn.py
